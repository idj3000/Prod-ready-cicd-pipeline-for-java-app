...
1) Create a GitHub Repository
    ...
    - Click on `Create` to Create a Repository
     ...
     - Click on `Create`
     - Download the Project Zip from https://github.com/idj3000/Prod-ready-cicd-pipeline-for-java-app.git
...
2) SonarQube
    ...
    - User data (Copy the following user data): https://github.com/idj3000/Prod-ready-cicd-pipeline-for-java-app/blob/main/sonarqube-install.sh
    - Launch Instance
...
3) Maven
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/idj3000/Prod-ready-cicd-pipeline-for-java-app/blob/main/maven-install.md
    - Launch Instance
...
4) Nexus
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/idj3000/Prod-ready-cicd-pipeline-for-java-app/blob/main/nexus-install.sh
    - Launch Instance
