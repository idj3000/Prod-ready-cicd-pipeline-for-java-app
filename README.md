...
1) Create a GitHub Repository
    ...
    - Click on `Create` to Create a Repository
     ...
     - Click on `Create`
     - Download the Project Zip from https://github.com/idj300/maven-sonarqube-nexus
...
2) SonarQube
    ...
    - User data (Copy the following user data): https://github.com/idj3000/sonarqube-install.sh
    - Launch Instance
...
3) Maven
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/idj3000/maven-install.md
    - Launch Instance
...
4) Nexus
    ...
    - Key pair: Select or create a new keypair
    - User data (Copy the following user data): https://github.com/idj3000/nexus-install.sh
    - Launch Instance
